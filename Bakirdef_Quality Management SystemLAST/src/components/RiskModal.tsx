    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-gray-900">{risk ? 'Edit Risk' : 'Identify New Risk'}</h2>
            <p className="text-gray-600 mt-1">AS9100 Clause 6.1 - Risk-Based Thinking</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            <label className="block text-gray-700 mb-2">Risk Title *</label>
            <input
              type="text"
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <h3 className="text-gray-900 mb-3">Risk Assessment</h3>
            ...
            <div className="p-3 bg-white rounded border border-gray-200">
              <p className="text-gray-600 mb-1">Calculated Risk Level</p>
              <p className="text-gray-900">
                <span className={`px-3 py-1 rounded text-white ${
                  formData.riskLevel >= 15 ? 'bg-red-500' :
          ...
          <div>
            <label className="block text-gray-700 mb-2">Mitigation Plan</label>
            <textarea
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-2">
              <label className="block text-gray-700 mb-2">Risk Owner *</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-700 mb-2">Residual Risk</label>
              <input
                type="number"
                min="0"
                max="25"
          ...
          <div>
            <label className="block text-gray-700 mb-2">Date Identified *</label>
            <input
              type="date"
