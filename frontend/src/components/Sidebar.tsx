...
export function Sidebar({ role, username, activeTab, onTabChange, onLogout }: SidebarProps) {
    const navItems = getNavItemsByRole(role);

    return (
        <div className="w-64 bg-slate-900 text-slate-400 border-r border-slate-800 h-screen flex flex-col sticky top-0 shrink-0 font-sans">
